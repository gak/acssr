...
// Ver:		$Id: jpgraph_pie.php,v 1.49.2.19 2004/10/02 06:50:31 aditus Exp $
//
...
class PiePlot {
    ...
    public $radius=0.3;
    public $explode_radius=array(),$explode_all=false,$explode_r=20;
    ...
    public $legendcsimtargets = array();
    public $legendcsimalts = array();
    public $adjusted_data = array();
